...
await build({entryPoints:['src/index.mjs'],bundle:true,format:'esm',platform:'node',target:'node22',outfile:'lib/index.js',external:['relay-dsh-plugin-codex'],loader:{'.md':'text','.py':'text'},banner:{js:"import {createRequire as speechCreateRequire} from 'node:module';const require=speechCreateRequire(import.meta.url);"}})
